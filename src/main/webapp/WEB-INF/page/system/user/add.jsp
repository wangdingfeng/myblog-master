...
<body>
<form class="form-horizontal layui-form layui-form-pane" method="post" action="${app}/system/user/doAdd">
   <div class="box-body">
     <div class="form-group">
       <label for="uname" class="col-sm-2 control-label">用户名</label>
       <div class="col-sm-12">
      		<input type="text" id="uname" name="userName" class="form-control" placeholder="请输入用户名" lay-verify="required|username|check" check-url="<%=request.getContextPath()%>/system/user/checkName">
     	</div>
     </div>
     <div class="form-group">
